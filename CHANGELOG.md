...
### Fixed
- Relax multiplayer active location checking when fetching NPCs
- Switch to mod data for storing birthdays

## [1.1.5]

### Added
- improve little NPC compat, add API checks and try to sort non-hmk custom kids later than custom kids

## [1.1.4]

### Fixed
- Tentative fix for adopted kid not getting bed.

## [1.1.3]

### Fixed
- Generic children with name that overlap with vanilla character fetching their dialogue.
- Improved compatibility with LittleNPC by checking it's logic for whether a child is LittleNPC controlled.
